...
namespace ToDoListEditor
{
    ...
    public class TaskConfig
    {
        ...
        public const string RuleStr = "规则列表";
    ...
    [CreateAssetMenu(fileName = TaskConfig.RuleStr, menuName = TaskConfig.RuleStr)]
    public class RuleListConfigObject : SerializedScriptableObject
    {
        [LabelText("·")]
        //[HideLabel]
        [ListDrawerSettings(Expanded = true, DraggableItems = false, ShowItemCount = false)]
